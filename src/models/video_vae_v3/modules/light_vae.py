# Ported from LightX2V/lightx2v/models/video_encoders/hf/wan/vae.py
# Adapted for SeedVR2
...
from .types import CausalAutoencoderOutput, CausalDecoderOutput, CausalEncoderOutput, DecoderOutput, DiagonalGaussianDistribution
...
class LightVAEWrapper(nn.Module):
    ...
    def encode(self, x: torch.FloatTensor, return_dict: bool = True, tiled: bool = False,
        ...
        # So we wrap it in a pseudo-distribution for compatibility
        ...
        return CausalEncoderOutput(z, PseudoDist(z))
    ...
    def set_causal_slicing(self, *args, **kwargs):
        # LightVAE handles this internally or via tiling, dummy implementation for interface compat
        pass

    def set_memory_limit(self, *args, **kwargs):
        # Dummy implementation for interface compat
        pass
